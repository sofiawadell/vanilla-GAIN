        ...
        for data_name in all_datasets:
            for miss_rate in all_missingness:
                ...
                for i in range(1, no_datasets+1):
                    ...
                    if extra_amount == 0:
                        filename_imputed_data = 'imputed_data/{}/{}_{}_wo_target_{}.csv'.format(data_name, data_name, miss_rate, i)
                    else:
                        filename_imputed_data = 'imputed_data/{}/{}_{}_wo_target_extra_{}_{}.csv'.format(data_name, data_name, miss_rate, extra_amount, i)
...
if __name__ == '__main__':
    ...
    df_results = main()
    df_results.to_csv('results/prediction_average_GAIN.csv', index=False)
