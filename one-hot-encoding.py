...
for col in cat_cols:
    ...
    categories = complete_data[col].unique()
    encoded_col_missing = pd.get_dummies(missing_data[col], prefix=col, columns=categories)
    encoded_col_complete = pd.get_dummies(complete_data[col], prefix=col, columns=categories)
