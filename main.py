...
def main (args):
  ...
  test_ori_data, test_miss_data, test_data_m, norm_params_train, column_names = data_loader(data_name, miss_rate, extra_amount) 
...
if __name__ == '__main__':  
  ...
  parser.add_argument(
      '--extra_amount',
      help='extra amount of training data generated by CTGAN',
      default=0,
      type=int)
  parser.add_argument(
      '--batch_size',
